...
class EqualsSearchOperator extends AbstractSearchOperator implements SearchOperatorInterface
{
    public function __construct()
    {
        $this->setLabel(Comparison::EQ);
    }
    ...
    public function getExpr()
    {
        ...
        return new OperatorExpression(
            new AdminComparison($this->getAliasedAttribute(), Comparison::EQ, ':' . $this->getAttribute()),
            $this->getAttribute(),
            $this->getValue()
        );
    }
